...
const MainPage: React.FC = () => {
  ...
  const handleClick = (item: Movie | TVShow) => {
          ...
          {trendingAll.map((item) => {
            ...
            return (
              <div
                ...
                className="bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:scale-105 hover:shadow-red-600/50 cursor-pointer transition-transform duration-300"
              >
                {item.poster_path ? (
                  <img
